		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comnagarrolabormanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnagarrolabormanager-display": {
								"semanticObject": "comnagarrolabormanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nagarro.labormanager",
									"url": sap.ui.require.toUrl("com/nagarro/labormanager")
								}
							}
						}
					}
